...
public sealed class ValidateAsync
{
    ...
    public async Task WhenApiKeyIsEmpty_ReturnsInvalid()
    {
        ...
        {
            Settings = new GlobalSettingsSummary("ApiKey", 1, 120, false, false, null, null, null, null, null, false, true, 60, false, false, false, false, ImageBuildStatus.Idle, null),
    ...
    public async Task WhenOAuthExpired_ReturnsInvalid()
    {
        ...
        FakeGlobalSettingsQueries queries = new()
        {
            Settings = new GlobalSettingsSummary("OAuth", 1, 120, true, true, expiredAt, "pro", null, null, null, false, true, 60, false, false, false, false, ImageBuildStatus.Idle, null),
        };
        AnthropicAuthValidator sut = BuildSut(queries: queries);
    ...
    public async Task WhenOAuthExpiresAtIsNull_ReturnsInvalid()
    {
        ...
        FakeGlobalSettingsQueries queries = new()
        {
            Settings = new GlobalSettingsSummary("OAuth", 1, 120, true, true, null, "pro", null, null, null, false, true, 60, false, false, false, false, ImageBuildStatus.Idle, null),
        };
        AnthropicAuthValidator sut = BuildSut(queries: queries);
    ...
    public async Task WhenOAuthValid_ReturnsValid()
    {
        ...
        FakeGlobalSettingsQueries queries = new()
        {
            Settings = new GlobalSettingsSummary("OAuth", 1, 120, true, true, futureExpiry, "pro", null, null, null, false, true, 60, false, false, false, false, ImageBuildStatus.Idle, null),
        };
        AnthropicAuthValidator sut = BuildSut(queries: queries);
