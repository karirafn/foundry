...
public sealed class PersistReviewToFailedIssue : IAsyncDisposable
{
    ...
    public async Task WhenReviewIssueFailedTransitioned_CanBeReloadedAsFailedIssueWithAllFields()
    {
        ...
        ReviewIssue review = inProgress.MarkInReview(reviewWorkerRunId, "feat/issue-55", "https://github.com/owner/repo/pull/7");
        ...
        await _dbContext.TransitionAsync(review, failed, TestContext.Current.CancellationToken);
