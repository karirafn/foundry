...
public sealed class SavingChanges : IAsyncDisposable
{
    ...
    [Fact]
    public void WhenEventEnqueuedBeforeSyncSave_OutboxMessagePersisted()
    {
        // Arrange
        ...
        List<OutboxMessage> messages = _dbContext
            .Set<OutboxMessage>()
            .ToList();
    ...
    [Fact]
    public void WhenEventEnqueuedAndSyncSaveCalledTwice_ExactlyOneOutboxMessagePersisted()
    {
        // Arrange
        _collector.Enqueue(MakeEvent());
